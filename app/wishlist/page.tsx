              ...
              {wishlist.map((item) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-red-50 group"
                  >
                    <Heart
                      size={20}
                      className="fill-red-500 text-red-500 group-hover:scale-110 transition-transform"
                    />
                  </button>
