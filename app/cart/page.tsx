            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {cart.length > 0 && (
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  {appliedPromo ? (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 animate-slide-down animate-success-pulse relative overflow-hidden">
                      {/* Shimmer effect */}
                    ...
                    <>
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          disabled={promoLoading}
                          className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 font-medium disabled:bg-gray-400 disabled:cursor-not-allowed"
                        >
